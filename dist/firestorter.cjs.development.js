          ...
          switch (_context.prev = _context.next) {
            ...
            case 14:
              ...
              mobx.runInAction(function () {
                ...
                if (_this2.isVerbose) {
                  console.debug(_this2.debugName + " - fetched: " + JSON.stringify(mobx.toJS(_this2.data)));
                }
              });
...
var Collection = /*#__PURE__*/function () {
  ...
  function Collection(source, options) {
    ...
    this.queryRefObservable = mobx.observable.box(undefined); // this._limit = observable.box(limit || undefined);
...
var GeoQuery = /*#__PURE__*/function (_AggregateCollection) {
  ...
  function GeoQuery(source, options) {
    ...
    mobx.makeObservable(_assertThisInitialized(_this), {
...
exports.makeCompatContext = makeCompatContext;
...
//# sourceMappingURL=firestorter.cjs.development.js.map
