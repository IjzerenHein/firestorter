  ...
  return rollup
    ...
    .then((bundle) =>
      bundle.write({
        ...
        format,
        name: moduleName,
        banner: '/** Firestorter - (c) Hein Rutjes 2017 - 2022 - MIT Licensed */',
        exports: 'named',
        globals: {
          mobx: 'mobx',
        },
...
function generateMinified() {
  ...
  exec(
    `${getCmd(
      'uglifyjs'
    )} --toplevel -m -c warnings=false --preamble "/** Firestorter - (c) Hein Rutjes 2017 - 2022 - MIT Licensed */" --source-map -o lib/firestorter.min.js lib/firestorter.prod.js`
  );
  exec(`${getCmd(`envify`)} lib/firestorter.umd.js > lib/firestorter.prod.umd.js`, {
    env: prodEnv,
  });
  exec(
    `${getCmd(
      `uglifyjs`
    )} --toplevel -m -c warnings=false --preamble "/** Firestorter - (c) Hein Rutjes 2017 - 2022 - MIT Licensed */" --source-map -o lib/firestorter.umd.min.js lib/firestorter.prod.umd.js`
  );
